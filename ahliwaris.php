...
<body>
    ...
    <table width="500" border="1">
        <h1>Persyaratan</h1>
		<tr><th colspan="100%" scope="col" bgcolor="blue">surat keterangan ahli waris</th>
			<tr>
				<td bgcolor="green">surat keterangan ahli waris dari wali nagari</td>
			</tr>
		
			<tr>
				<td bgcolor="green">fotokopy kk dan e-ktp</td>
			</tr>
            ...
            <tr>
				<td bgcolor="green">fotocopy dokumen yang dibutuhkan untuk 
                keterangan ahli warid di maksud (fotokopy sertifikat)/td>
			</tr>
	</table>
    </div>
